...
public class Employee extends User {
    ...
    public Employee(String role, Customer customer) {
        super(customer.getFirstName(), customer.getPrefix(), customer.getLastName(), customer.getAddress(), customer.getSocialSecurityNumber(), customer.getDateOfBirth(), customer.getEmail());
